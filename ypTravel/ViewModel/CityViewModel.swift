...
class CityViewModel: ObservableObject {
    ...
    init() {
//        let city_1 = City(name: "Москва", stations: viewModel.moscowStation)
//        let city_2 = City(name: "Санкт Петербург", stations: viewModel.spbStation)
//        let city_3 = City(name: "Сочи", stations: viewModel.sochiStation)
//        let city_4 = City(name: "Горный воздух", stations: viewModel.gvStation)
//        let city_5 = City(name: "Краснодар", stations: viewModel.krasnodarStation)
//        let city_6 = City(name: "Казань", stations: viewModel.kazanStation)
//        let city_7 = City(name: "Омск", stations: viewModel.omskStation)
